...
* Double-clicking data objects (mapped super classes and entities), settings containers and relationships opens an embedded textual editor inside the diagram editor.
...
* The default target version is now `ZK15`. In the same step `ZK14` and `ZK14DEV` have been marked as deprecated and will be removed after the release of ModuleStudio 1.0.2 (#1081).
