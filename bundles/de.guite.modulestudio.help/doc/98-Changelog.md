...
* Removed listener generation for some deprecated events (related to `user.gettheme`, old module dispatching, legacy APIs, legacy core, Smarty theme templates, Smarty module templates).
