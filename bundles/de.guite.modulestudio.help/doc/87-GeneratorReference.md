...
* **formAwareHookProvider** - Allows to specify whether a [form aware hook provider](https://github.com/zikula/core/tree/master/src/docs/Hooks) should be generated for the entity. Default value is `DISABLED`. Allowed values are explained [here](#hook-provider-mode). This has no effect for Zikula 1.4 and is only supported for 1.5+.
...
* **uiHooksProvider** - Allows to specify whether a [UI hooks provider](https://github.com/zikula/core/tree/master/src/docs/Hooks) should be generated for the entity. Default value is `DISABLED`. Allowed values are explained [here](#hook-provider-mode). This has no effect for Zikula 1.4 and is only supported for 1.5+.
