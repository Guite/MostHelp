...
* Avoid invalid item actions for unidirectional many-to-many relationships.
...
* The `nospace` property has been deprecated and will be removed in ModuleStudio 1.3.2 (#1174). A quick fix is provided for simple migration.
...
* The default target version is now `ZK15`. In the same step `ZK14` and `ZK14DEV` have been marked as deprecated and will be removed after the release of ModuleStudio 1.3.2 (#1081).
