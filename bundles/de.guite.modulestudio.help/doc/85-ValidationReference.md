...
* handler, hash, hashed_value, having, help, high_priority, hint, hold, holdlock, host, hosts, hour, hours, hour_microsecond, hour_minute, hour_second
...
* obid, of, off, offline, offset, offsets, old, old_table, on, once, one, online, only, open, opendatasource, openquery, openrowset, optimization, optimize, optimizer_costs, option, optionally, options, or, order, out, outer, outfile, over, overlaps, overriding, owner
